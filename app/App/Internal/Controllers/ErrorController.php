...
/**
 * ErrorController - Framework Internal
 * Menangani render halaman error standar (404, 500, dll) secara elegan.
 */
class ErrorController
{
    ...
    public static function databaseError(\TheFramework\App\Database\DatabaseException $e)
    {
        http_response_code(500);
