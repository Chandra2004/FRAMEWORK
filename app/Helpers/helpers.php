...
if (!function_exists('url')) {
    function url(string $path = '') { return Helper::url($path); }
}
...
if (!function_exists('request')) {
    function request($key = null, $default = null) { return Helper::request($key, $default); }
}
...
if (!function_exists('csrf_token')) {
    function csrf_token() { return Helper::generateCsrfToken(); }
}
...
if (!function_exists('e')) {
    function e($value) { return Helper::e($value); }
}
...
if (!function_exists('old')) {
    function old(string $field, $default = null) {
...
if (!function_exists('rupiah')) {
    function rupiah($number) { return Helper::rupiah($number); }
}
