...
// Agar PHPUnit bisa menangkap exception dengan wajar
...
if (php_sapi_name() !== 'cli') {
    ...
    TheFramework\App\RateLimiter::check($_SERVER['REMOTE_ADDR'] ?? '127.0.0.1', 100, 120);
...
$container->singleton(\TheFramework\Services\UserService::class, function () {
    return new \TheFramework\Services\UserService();
});

// 4. Controllers (Optional: Jika ingin tanpa reflection sama sekali)
// $container->bind(HomeController::class, fn() => new HomeController(new UserService()));

// --- ROUTING SYSTEM ---
// Route File Serving Route (Private Uploads)
// Pindahkan ini ke routes/web.php atau biarkan disini jika ingin hardcoded system route
